...
<head>
  <meta charset="utf-8">
  <title>page annonces bord de la mer</title>
...
<body class="index-page">
            ...
            <div class="row d-flex align-items-stretch">
                <div class="col-md-12">
                    <div class="title-single-box">
                        <h1 class="title-single">Nos locations au Bord de la mer</h1>
                    </div>
                </div>
            </div>
        </div>
 ...
 <section class="property-grid grid">
            <div class="container">
                ...
                // Total des annonces
                $totalAnnonces = $db->query("SELECT COUNT(*) FROM bien_a_louer_pour_vacances WHERE destination = 'bord_de_la_mer'")->fetchColumn();
                $totalPages = ceil($totalAnnonces / $annoncesParPage);
                ...
                $requete = $db->prepare("SELECT bl.*, tp.nom AS nom_type
                    ...
                    JOIN type_bien tp ON bl.id_type = tp.id
                    WHERE bl.destination = 'bord_de_la_mer'
                                ...
                                <div class="card-overlay-a-content" style="position: relative;">
                                    ...
                                    <div class="card-body-a">
                                        <div class="price-box d-flex">
                                            <span class="price-a">Prix | DA <?= number_format($annonce['prix_par_nuit'], 0, ',', ' '); ?></span>
                                        </div>
