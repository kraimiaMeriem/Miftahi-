...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $accepte_credit_bancaire = ($_POST['accepte_credit_bancaire'] === 'oui') ? 1 : 0;
    ...
    $piece = trim($_POST["piece"]); // Ne pas utiliser htmlspecialchars sur un nombre
    ...
    try {
        $sql = "INSERT INTO bien_a_vendre (id_utilisateur, id_type, titre, wilaya, adresse, superficie, etat, accepte_credit_bancaire, piece, prix, photos, description)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $db->prepare($sql);
        $stmt->execute([$id_utilisateur, $id_type, $titre, $wilaya, $adresse, $superficie, $etat, $accepte_credit_bancaire, $piece, $prix, $photo_path_to_insert, $description]);

        header("Location: formulaire_vente.php?success=1");
        exit;
    } catch (PDOException $e) {
...
<main class="main">
    ...
    <form method="POST" action="Annonce_de_vente.php" enctype="multipart/form-data">
    ...
    <div class="form-group-photos">
        ...
        <div class="form-row">
            ...
            <div class="form-col-right">
                ...
                <div class="form-group">
                            <label for="accepet_credit_bancaire">Accepet Credit Bancaire :</label>
                                <select id="accepte_credit_bancaire" name="accepte_credit_bancaire" required>
