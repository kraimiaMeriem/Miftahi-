...
<body class="index-page">
  ...
  <main class="main">
    <img src="assets/img/etapes-cles.jpg" alt="Les étapes clés "> 
        <h1>Les étapes clés pour louer un bien en toute sérénité</h1></br>
    
        <h2>1. Définir ses critères de recherche</h2>
        <p>Surface, localisation, budget, type de bien... il faut établir vos priorités.</p>
    
        <h2>2. Constituer un dossier solide</h2>
        <p>Préparez à l’avance les documents nécessaires (identité, revenus, garant).</p>
    
        <h2>3. Organiser les visites</h2>
        <p>Préférez les visites en journée pour bien évaluer l’état du bien et son environnement.</p>
    
        <h2>4. Lire attentivement le bail</h2>
        <p>Vérifiez la durée, les clauses spécifiques, le montant du dépôt de garantie, etc.</p>
    
        <h2>5. Réaliser l’état des lieux</h2>
        <p>Un état des lieux précis évite les litiges lors du départ.</p>
    
        <p>En suivant ces étapes, vous mettez toutes les chances de votre côté pour une location sans mauvaise surprise.</p>
