        ...
        <form action="connexion.php" method="POST">
            ...
            <div class="password-container">
                ...
                <div class="relative w-full">
                    <input type="password" id="password" name="mot_de_passe" placeholder="Mot de passe" required class="w-full">
                    <i class="fa-solid fa-eye toggle-password" id="togglePassword"></i>
                </div>
            </div>

            <a href="mtp.php" class="text-sm text-indigo-600 hover:underline block text-right mt-1">Mot de passe oublié ?</a>

            <button type="submit" class="btn">
                <span x-show="!loading">Se connecter</span>
            </button>

            <p class="mt-4">Vous n'avez pas de compte ?</p>
            <a href="inscription.php">
                <button type="button" class="btn">Créer un compte</button>
            </a>
        </form>
        </div>
</main>
