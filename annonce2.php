...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    try {
        // MODIFICATION ICI: Changé de 'bien_a_louer' à 'bien_a_louer_pour_vacances'
        // et ajusté les colonnes pour correspondre à 'bien_a_louer_pour_vacances'
        $sql = "SELECT b.*, t.nom as type_nom, u.nom as nom_utilisateur, u.numtel
                FROM bien_a_louer_pour_vacances b
...
<head>
  <meta charset="utf-8">
  <title>Annonces de Location de Vacances Alger</title>
...
<body class="annoncevacance-page">
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Louer</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                        <ul>
                            <li><a href="location_proprietaire.php">Mettre en location</a></li>
                            <li><a href="location_client.php">Chercher une location</a></li>
                        </ul>
                    </li>
                    <li><a href="vacances.php">Vacances</a></li> <li><a href="#demenagement">Déménagement</a></li>
                </ul>
    ...
    <ul class="details-list">
        ...
        <li><strong>Parking</strong> <?php echo ($annonce['parking'] == 1 ? 'Oui' : 'Non'); ?></li>
        <li><strong>Piscine:</strong> <?php echo ($annonce['piscine'] == 1 ? 'Oui' : 'Non'); ?></li>
        <li><strong>Wifi:</strong> <?php echo ($annonce['wifi'] == 1 ? 'Oui' : 'Non'); ?></li>
        <li><strong>Climatisation:</strong> <?php echo ($annonce['climatisation'] == 1 ? 'Oui' : 'Non'); ?></li>
        <li><strong>Chauffage:</strong> <?php echo ($annonce['chauffage'] == 1 ? 'Oui' : 'Non'); ?></li>
        <li><strong>Accepte Animaux:</strong> <?php echo ($annonce['accepte_animaux'] == 1 ? 'Oui' : 'Non'); ?></li>
        <li><strong>Nombre de pièces:</strong> <?php echo htmlspecialchars($annonce['nbr_de_pieces']); ?></li>
        <li><strong>Prix par Nuit:</strong> <?php echo number_format($annonce['prix_par_nuit'], 2, ',', ' '); ?> DZD</li>
        <li><strong>Capacité d'Accueil:</strong> <?php echo htmlspecialchars($annonce['capacite']); ?> personnes</li>
        <li><strong>Période Disponible:</strong> <?php echo nl2br(htmlspecialchars($annonce['disponibilite'])); ?></p>
    </ul>
</div>
