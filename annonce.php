...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    try {
        // MODIFICATION CRUCIALE ICI: Changé 'u.nom_utilisateur' à 'u.nom' et ajouté 'u.numtel'
        $sql = "SELECT b.*, t.nom as type_nom, u.nom as nom_utilisateur, u.numtel
                FROM bien_a_vendre b
...
<head>
  <meta charset="utf-8">
  <title>annonces de vente Alger</title>
...
<body class="annoncevacance-page">
    ...
    ?>
                 <li><strong>Wilaya:</strong> <?php echo htmlspecialchars($wilayas[$annonce['wilaya']]); ?></li>
                 ...
                 <li><strong>Prix:</strong> <?php echo number_format($annonce['prix'], 2, ',', ' '); ?> DZD</li>
                 <li><strong>Crédit bancaire accepté:</strong> <?php echo ($annonce['accepte_credit_bancaire'] ? 'Oui' : 'Non'); ?></li>
                </ul>
            </div>
