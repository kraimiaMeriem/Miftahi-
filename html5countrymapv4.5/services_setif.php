  ...
  <div class="avatar-container">
    ...
    <main id="main">
        ...
        <section id="demenagement-list" class="demenagement-list">
            <div class="container">
                <h1>Trouvez l'agence de déménagement idéale à Sétif!</h1>
                ...
                <section class="agences-list">
                    <div class="agence-card">
                        <div class="agence-info">
                            <h3>SNC Ketfi Déménagement </h3>
                            <p class="wilaya"><i class="fas fa-city"></i> Sétif</p>
                            <p class="adresse"><i class="fas fa-map-marker-alt"></i> </p>
                            <p class="telephone"><i class="fas fa-phone"></i> 0676 19 23 50</p>
                            <p class="email"><i class="fas fa-envelope"></i> </p>
                            <p class="siteweb"><i class="fas fa-globe"></i> <a href="" target="_blank"></a></p>
                            <p class="description">SNC Ketfi Déménagement est une entreprise locale offrant des services complets de déménagement pour particuliers. Leurs prestations incluent:Déménagement de meubles, Démontage et montage de meubles et climatiseurs, Emballage sur demande avec garantie de transport sécurisé, Équipe professionnelle adaptée à vos besoins.</p>
                        </div>
                    </div>

                    <div class="agence-card">
                        <div class="agence-info">
                            <h3>Houssem Eddine Saidia – Transport et Déménagement</h3>
                            <p class="wilaya"><i class="fas fa-city"></i> Sétif</p>
                            <p class="adresse"><i class="fas fa-map-marker-alt"></i> </p>
                            <p class="telephone"><i class="fas fa-phone"></i> 0633 24 88 80 </p>
                            <p class="email"><i class="fas fa-envelope"></i> </p>
                            <p class="siteweb"><i class="fas fa-globe"></i> <a href="" target="_blank"></a></p>
                            <p class="description">Houssem Eddine Saidia propose des services de transport et de déménagement disponibles 24h/24 et 7j/7 vers toutes les destinations en Algérie.</p>
                        </div>
                    </div>
