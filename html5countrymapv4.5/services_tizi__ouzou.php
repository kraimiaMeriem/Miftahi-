...
<head>
  <meta charset="utf-8">
  <title>services Tizi Ouzou</title>
  ...
  <div class="avatar-container">
    ...
    <main id="main">
        ...
        <section id="demenagement-list" class="demenagement-list">
            <div class="container">
                <h1>Trouvez l'agence de déménagement idéale à Tizi Ouzou!</h1>
                ...
                <section class="agences-list">
                    <div class="agence-card">
                        <div class="agence-info">
                            <h3>Tizi Déménagement</h3>
                            <p class="wilaya"><i class="fas fa-city"></i> Tizi Ouzou</p>
                            <p class="adresse"><i class="fas fa-map-marker-alt"></i> </p>
                            <p class="telephone"><i class="fas fa-phone"></i> 0560 64 66 93</p>
                            <p class="email"><i class="fas fa-envelope"></i> </p>
                            <p class="siteweb"><i class="fas fa-globe"></i> <a href="" target="_blank"></a></p>
                            <p class="description">Tizi Déménagement est une entreprise locale offrant des services de déménagement à Tizi Ouzou et dans toute l'Algérie. Elle propose des prestations simples et rapides, assurées par des déménageurs qualifiés.</p>
                        </div>
                    </div>

                    <div class="agence-card">
                        <div class="agence-info">
                            <h3>Déménagement Express </h3>
                            <p class="wilaya"><i class="fas fa-city"></i> Tizi Ouzou</p>
                            <p class="adresse"><i class="fas fa-map-marker-alt"></i> </p>
                            <p class="telephone"><i class="fas fa-phone"></i> 0698 00 86 74   </p>
                            <p class="email"><i class="fas fa-envelope"></i> </p>
                            <p class="siteweb"><i class="fas fa-globe"></i> <a href="" target="_blank"></a></p>
                            <p class="description">Déménagement Express Tizi Ouzou offre des services complets de déménagement, incluant le montage et le démontage de meubles. L'entreprise est disponible pour répondre à vos besoins de déménagement dans la région.</p>
                        </div>
                    </div>
