...
<head>
  <meta charset="utf-8">
  <title>services costantine</title>
  ...
  <div class="avatar-container">
    ...
    <main id="main">
        ...
        <section id="demenagement-list" class="demenagement-list">
            <div class="container">
                <h1>Trouvez l'agence de déménagement idéale à Costantine!</h1>
                ...
                <section class="agences-list">
                    ...
                    <div class="agence-card">
                        <div class="agence-info">
                            <h3>Les Frères Déménageurs</h3>
                            <p class="wilaya"><i class="fas fa-city"></i> costantine</p>
                            <p class="adresse"><i class="fas fa-map-marker-alt"></i>  </p>
                            <p class="telephone"><i class="fas fa-phone"></i> 0557097540</p>
                            <p class="email"><i class="fas fa-envelope"></i> </p>
                            <p class="siteweb"><i class="fas fa-globe"></i> <a href="" target="_blank"></a></p>
                            <p class="description">Entreprise locale spécialisée dans le déménagement résidentiel à Constantine et ses environs. Elle propose des services complets incluant l'emballage, le démontage et le transport sécurisé de vos biens. L'équipe est reconnue pour son professionnalisme et sa ponctualité.</p>
                        </div>
                    </div>

                    <div class="agence-card">
                        <div class="agence-info">
                            <h3> Groupe Professionnel de Déménagement</h3>
                            <p class="wilaya"><i class="fas fa-city"></i> costantine</p>
                            <p class="adresse"><i class="fas fa-map-marker-alt"></i> </p>
                            <p class="telephone"><i class="fas fa-phone"></i> 0770 52 59 88  </p>
                            <p class="email"><i class="fas fa-envelope"></i> </p>
                            <p class="siteweb"><i class="fas fa-globe"></i> <a href="" target="_blank"></a></p>
                            <p class="description">Ce groupe offre des services de déménagement pour particuliers, avec une équipe expérimentée assurant le démontage, l'emballage et le transport de vos meubles et effets personnels. Ils sont disponibles pour des déménagements locaux et inter-wilayas.</p>
                        </div>
                    </div>
                    ...
                    <div class="agence-card">
                      <div class="agence-info">
                          ...
                          <p class="wilaya"><i class="fas fa-city"></i> Costantine</p>
                          <p class="adresse"><i class="fas fa-map-marker-alt"></i> </p>
                          <p class="telephone"><i class="fas fa-phone"></i> 0664839741  </p>
                          <p class="email"><i class="fas fa-envelope"></i> </p>
                          <p class="siteweb"><i class="fas fa-globe"></i> <a href="" target="_blank"></a></p>
                          <p class="description">Khidma-TeC propose des services de déménagement à Constantine, incluant le démontage, l'emballage et le transport de vos biens. L'entreprise est connue pour sa réactivité et son professionnalisme.</p>
                      </div>
                  </div>
