  ...
  <div class="avatar-container">
    ...
    <main id="main">
        ...
        <section id="demenagement-list" class="demenagement-list">
            <div class="container">
                <h1>Trouvez l'agence de déménagement idéale à Oran!</h1>
                ...
                <section class="agences-list">
                    <div class="agence-card">
                        <div class="agence-info">
                            <h3>Bahia Déménagement</h3>
                            <p class="wilaya"><i class="fas fa-city"></i> Oran</p>
                            <p class="adresse"><i class="fas fa-map-marker-alt"></i>  32 Cité Nakhla, Bir El Djir, Oran  </p>
                            <p class="telephone"><i class="fas fa-phone"></i> 05 55 67 69 81 </p>
                            <p class="email"><i class="fas fa-envelope"></i> </p>
                            <p class="siteweb"><i class="fas fa-globe"></i> <a href="" target="_blank"></a></p>
                            <p class="description">Bahia Déménagement est une entreprise locale spécialisée dans le transport et le déménagement de particuliers à Oran. Elle propose un service complet, incluant l'emballage, le démontage/remontage des meubles et le transport sécurisé de vos biens. Réputée pour sa ponctualité et son sérieux, elle offre également des devis gratuits.</p>
                        </div>
                    </div>
                    ...
                    <div class="agence-card">
                        <div class="agence-info">
                            ...
                            <p class="email"><i class="fas fa-envelope"></i> </p>
                            <p class="siteweb"><i class="fas fa-globe"></i> <a href="https://m2rmaritime.com/afrique/transitaire-algerie/demenagement-oran/" target="_blank"></a> m2rmaritime.com​</p>
                            <p class="description">M2R Maritime est spécialisée dans le déménagement international, notamment pour les personnes qui s’installent ou quittent Oran. Elle propose une prise en charge complète, du domicile jusqu’à la destination finale, avec des solutions personnalisées pour les expatriés et les familles. Elle se distingue par son savoir-faire logistique.</p>
                        </div>
                    </div>
