  ...
  <div class="avatar-container">
    ...
    <main id="main">
        ...
        <section id="demenagement-list" class="demenagement-list">
            <div class="container">
                <h1>Trouvez l'agence de déménagement idéale à Skikda!</h1>
                ...
                <section class="agences-list">
                    ...
                    <div class="agence-card">
                        <div class="agence-info">
                            <h3>SARL Transit Grand El Djoussour</h3>
                            <p class="wilaya"><i class="fas fa-city"></i> Skikda</p>
                            <p class="adresse"><i class="fas fa-map-marker-alt"></i> 23 Rue Tahar Djouad, Skikda </p>
                            ...
                            <p class="description">Entreprise spécialisée dans le déménagement toutes destinations, la manutention et le stockage de marchandises. Elle offre des services adaptés aux besoins des particuliers et des entreprises.</p>
                        </div>
                    </div>
