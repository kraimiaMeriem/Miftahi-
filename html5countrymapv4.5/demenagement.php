...
#map {
  width: 60%;
  height: 600px;
  margin-top: 20px; /* optionnel : pour un petit espace après le moteur de recherche */
  border-radius: 8px; /* optionnel : coins arrondis si tu veux un rendu plus sympa */
  box-shadow: 0 0 10px rgba(0,0,0,0.1); /* optionnel : petit effet d’ombre */
}
.main {
    padding-top: 80px; /* Ajustez cette valeur en fonction de la hauteur de votre header */
}
/* Style pour le bouton "Publier une annonce de déménagement" (exemple) */
.btn-box button {
    border: 1px solid #007bff; /* Couleur bleue (ajustez si nécessaire) */
    border-radius: 50px; /* Valeur élevée pour des coins très arrondis */
    color: #007bff; /* Couleur bleue du texte */
    background-color: white; /* Fond blanc */
    padding: 10px 20px; /* Ajustez le padding vertical et horizontal */
    cursor: pointer; /* Indique que c'est un élément cliquable */
    font-size: 16px; /* Taille de la police (ajustez si nécessaire) */
    transition: background-color 0.3s ease, color 0.3s ease; /* Pour des effets de survol doux */
}

.btn-box button:hover {
    background-color: #007bff; /* Couleur bleue au survol */
    color: white; /* Texte blanc au survol */
}

/* Style pour le bouton "Présenté votre service" */
.col-md-8 button { /* Cibler le bouton dans la colonne de la carte */
...
/* Style pour le bouton "Publier une annonce de déménagement" dans la section About */
...
/* Vous devrez peut-être cibler d'autres boutons spécifiques sur votre page
   en utilisant des sélecteurs CSS appropriés. Par exemple, si vous avez
   des boutons dans le footer ou ailleurs. */
</style>
</head>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Louer</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="location proprietaire.php">propriétaire</a></li>
              <li><a href="location client.php">Locataire</a></li>
            </ul>
          </li>
...
<div class="avatar-container">
  ...
  <main class="main">
    ...
    <div class="col-md-8">
        ...
        <button>Présenté votre service</button>
      </div>    
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="...">
            <div class="member">
              <a href="article 13.html"><img src="assets/img/carton.jpg" alt="" ></a>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              <a href="article 14.html"><img src="assets/img/demarches.jpg" alt="" ></a>
                <div class="member-info-content">
                  <h4>Quelles démarches administratives après un déménagement ?</h4>
              </div>
            </div>
          </div><!-- End Team Member -->
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <a href="article 15.html"><img src="assets/img/demenagement enfant.jpg" alt="" ></a>
                <div class="member-info-content">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="member">
              <a href="article 16.html"><img src="assets/img/erreursdem2.jpg" alt="" ></a>
                <div class="member-info-content">
