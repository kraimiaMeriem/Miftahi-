  ...
  <div class="avatar-container">
    ...
    <main id="main">
        ...
        <section id="demenagement-list" class="demenagement-list">
            <div class="container">
                <h1>Trouvez l'agence de déménagement idéale à Blida!</h1>
                ...
                <section class="agences-list">
                    ...
                    <div class="agence-card">
                        <div class="agence-info">
                            <h3>Société de Déménagement Tarek</h3>
                            <p class="wilaya"><i class="fas fa-city"></i> Blida</p>
                            <p class="adresse"><i class="fas fa-map-marker-alt"></i>36 Rue Tebbal Mohamed, Bouarfa, Blida</p>
                            ...
                            <p class="description">Basée à Bouarfa, cette entreprise est spécialisée dans les déménagements industriels et de particuliers.</p>
                        </div>
                    </div>
