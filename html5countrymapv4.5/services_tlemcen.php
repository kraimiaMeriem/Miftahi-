  ...
  <div class="avatar-container">
    ...
    <main id="main">
        ...
        <section id="demenagement-list" class="demenagement-list">
            <div class="container">
                <h1>Trouvez l'agence de déménagement idéale à Tlemcen!</h1>
                ...
                <section class="agences-list">
                    ...
                    <div class="agence-card">
                        <div class="agence-info">
                            <h3>Déménageur Tlemcen</h3>
                            <p class="wilaya"><i class="fas fa-city"></i> Tlemcen</p>
                            <p class="adresse"><i class="fas fa-map-marker-alt"></i>  </p>
                            <p class="telephone"><i class="fas fa-phone"></i> 0776 86 38 56</p>
                            <p class="email"><i class="fas fa-envelope"></i> </p>
                            <p class="siteweb"><i class="fas fa-globe"></i> <a href="" target="_blank"></a></p>
                            <p class="description">Entreprise locale offrant des services de déménagement 24h/24 et 7j/7, incluant le démontage et le montage de meubles. Elle est active sur les réseaux sociaux et propose un service fiable et rapide.</p>
                        </div>
                    </div>

                    <div class="agence-card">
                        <div class="agence-info">
                            <h3>Algérie Déménagement – Axe Tlemcen-Alger</h3>
                            <p class="wilaya"><i class="fas fa-city"></i> Tlemcen</p>
                            <p class="adresse"><i class="fas fa-map-marker-alt"></i> </p>
                            <p class="telephone"><i class="fas fa-phone"></i> 0552034620 </p>
                            <p class="email"><i class="fas fa-envelope"></i> </p>
                            <p class="siteweb"><i class="fas fa-globe"></i> <a href="" target="_blank"></a></p>
                            <p class="description">Spécialisée dans les déménagements entre Tlemcen et Alger, cette entreprise propose des services professionnels pour particuliers et entreprises, avec une équipe expérimentée en emballage et protection de mobilier.</p>
                        </div>
                    </div>
                </section>
            </div>
