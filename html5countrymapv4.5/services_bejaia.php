                ...
                <section class="agences-list">
                    ...
                    <div class="agence-card">
                        <div class="agence-info">
                            <h3>Déménagement Al Ahlam </h3>
                            <p class="wilaya"><i class="fas fa-city"></i>Bejaïa</p>
                            <p class="adresse"><i class="fas fa-map-marker-alt"></i> iheddaden, Bejaïa, Algeria </p>
                            <p class="telephone"><i class="fas fa-phone"></i> 0655 99 51 91</p>
                            <p class="email"><i class="fas fa-envelope"></i> z.hasniou@hotmail.com</p>
                            <p class="siteweb"><i class="fas fa-globe"></i> <a href="" target="_blank"></a></p>
                            <p class="description">Déménagement Al Ahlam propose des services professionnels incluant l'emballage, le transport, ainsi que le montage et démontage des meubles. L'entreprise est reconnue pour sa fiabilité et son professionnalisme.</p>
                        </div>
                    </div>

                    <div class="agence-card">
                        <div class="agence-info">
                            <h3>Kherbache Déménagement</h3>
                            <p class="wilaya"><i class="fas fa-city"></i> Bejaïa</p>
                            <p class="adresse"><i class="fas fa-map-marker-alt"></i> </p>
                            <p class="telephone"><i class="fas fa-phone"></i> 0776980857  </p>
                            <p class="email"><i class="fas fa-envelope"></i> </p>
                            <p class="siteweb"><i class="fas fa-globe"></i> <a href="" target="_blank"></a></p>
                            <p class="description">Kherbache Déménagement offre des services de déménagement sur toutes distances. L'entreprise est joignable au 0776 980 857 ou au 0550 602 912 pour toute demande d'information ou de devis.</p>
                        </div>
                    </div>
