...
<body class="index-page">
  ...
  <main class="main">
    <img src="assets/img/demenagement-avec-des-enfants.jpg" alt="nos astuces"> 
        <h1>Déménager avec des enfants : nos astuces</h1></br>
    
        <p>Un déménagement peut être une source de stress pour les enfants. Il est important de bien les préparer et de les impliquer dans ce changement.</p>
    
        <h2>1. Les prévenir à l’avance</h2>
    <p>Expliquez-leur les raisons du déménagement et rassurez-les. Plus ils sont informés, plus ils seront sereins.</p>

    <h2>2. Les impliquer</h2>
    <p>Faites-les participer à la préparation des cartons ou à la décoration de leur future chambre.</p>

    <h2>3. Maintenir une routine</h2>
    <p>Conservez autant que possible les horaires habituels (repas, sommeil) pour limiter le bouleversement.</p>

    <h2>4. Visiter le nouveau quartier</h2>
    <p>Faites-leur découvrir leur nouvel environnement pour créer des repères positifs.</p>

    <h2>5. Être patient après l’emménagement</h2>
    <p>Il leur faudra du temps pour s’adapter. Soyez à l’écoute et bienveillant.</p>
