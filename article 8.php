...
<body class="index-page">
  ...
  <main class="main">
    <img src="assets/img/achat.jpg" alt="Les étapes clés pour finalisser l'achat"> 
        <h1>Les étapes clés pour finalisser l'achat d'un bien en toute sécurité</h1></br>
    
        <ol>
            <li><strong>Évaluer son budget</strong> et obtenir un accord de principe bancaire</li>
            <li><strong>Rechercher et visiter des biens</strong></li>
            <li><strong>Faire une offre d’achat écrite</strong></li>
            <li><strong>Signer le compromis ou la promesse de vente</strong></li>
            <li><strong>Obtenir le prêt immobilier</strong></li>
            <li><strong>Signer l’acte authentique chez le notaire</strong></li>
            <li><strong>Récupérer les clés et emménager</strong></li>
          </ol>
          <p>Suivre ces étapes avec attention garantit une transaction sécurisée et sereine.</p>
