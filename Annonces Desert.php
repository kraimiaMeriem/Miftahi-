...
<head>
  <meta charset="utf-8">
  <title>page annonces desert</title>
...
<body class="index-page">
            ...
            <div class="row d-flex align-items-stretch">
                <div class="col-md-12">
                    <div class="title-single-box">
                        <h1 class="title-single">Nos locations dans le desert</h1>
                    </div>
                </div>
            </div>
        </div>
 ...
 <section class="property-grid grid">
            <div class="container">
                ...
                // Total des annonces
                $totalAnnonces = $db->query("SELECT COUNT(*) FROM bien_a_louer_pour_vacances WHERE destination = 'desert'")->fetchColumn();
                $totalPages = ceil($totalAnnonces / $annoncesParPage);
