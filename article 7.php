...
<body class="index-page">
  ...
  <main class="main">
    <img src="assets/img/erreurs.jpg" alt="Erreurs à éviter"> 
        <h1>Les 7 erreurs à éviter lors de l'achat d'un bien immobilier</h1></br>
    
        <ol>
            <li><strong>Ne pas définir son budget réel</strong> : incluez les frais de notaire, travaux, déménagement.</li>
            <li><strong>Oublier de comparer les offres bancaires</strong></li>
            <li><strong>Ne pas visiter suffisamment de biens</strong></li>
            <li><strong>Se précipiter sur le premier coup de cœur</strong></li>
            <li><strong>Oublier les diagnostics immobiliers</strong></li>
            <li><strong>Ne pas vérifier les charges de copropriété</strong></li>
            <li><strong>Signer un compromis sans tout comprendre</strong></li>
          </ol>
          <p>En évitant ces erreurs, vous sécurisez votre achat et gagnez en sérénité.</p>
  </main>
