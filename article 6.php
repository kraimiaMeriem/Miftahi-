...
<body class="index-page">
  ...
  <main class="main">
    <img src="assets/img/acheter sans agence.jpg" alt="Acheter sans agence"> 
        <h1>Acheter sans agence: les avantages et les précautions à prendre</h1></br>
    
        <p>Acheter un bien immobilier directement auprès du propriétaire peut vous faire économiser les frais d’agence. Voici les avantages et les points de vigilance :</p>
    <h2>Avantages</h2>
    <ul>
      <li>Économie de 3 à 8 % sur le prix du bien (frais d’agence non facturés)</li>
      <li>Négociation directe avec le vendeur</li>
      <li>Possibilité de mieux connaître l’historique du bien</li>
    </ul>
    <h2>Précautions à prendre</h2>
    <ul>
      <li>Vérifier tous les documents administratifs et diagnostics obligatoires</li>
      <li>Faire estimer le bien par un professionnel pour éviter une mauvaise surprise</li>
      <li>Faire appel à un notaire dès le début des discussions</li>
      <li>Vérifier l’absence de dettes liées à la copropriété ou d’hypothèques</li>
    </ul>
    <p>Acheter sans agence est possible, mais nécessite rigueur et vigilance.</p>
