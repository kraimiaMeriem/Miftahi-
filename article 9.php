...
<body class="index-page">
  ...
  <main class="main">
    <img src="assets/img/documents.jpg" alt="les documents à préparer"> 
        <h1>Location : les documents à préparer pour constituer un bon dossier</h1></br>
    
        <p>Lorsque vous souhaitez louer un logement, il est essentiel de présenter un dossier solide au propriétaire ou à l’agence immobilière. Un bon dossier rassure sur votre solvabilité et augmente vos chances d’obtenir le logement convoité.</p>
    
        <h2>1. Les pièces justificatives de base</h2>
        <ul>
          ...
          <li>Contrat de travail ou attestation de l’employeur</li>
          <li>Trois dernières quittances de loyer ou attestation d’hébergement</li>
        </ul>
    
        <h2>2. En cas de garant</h2>
        <p>Si un garant est nécessaire, il devra fournir les mêmes documents : identité, revenus, avis d’imposition et justificatif de domicile.</p>
