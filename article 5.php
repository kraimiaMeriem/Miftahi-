...
<body class="index-page">
  ...
  <main class="main">
    <img src="assets/img/documents achat.jpg" alt="les documents à préparer pour constituer un bon dossier"> 
        <h1>Achat : les documents à préparer pour constituer un bon dossier</h1></br>
    
        <p>Un dossier d’achat immobilier bien préparé peut faire la différence face à d’autres acheteurs. Voici les documents essentiels à réunir :</p>
    
        <ul>
            <li><strong>Pièce d’identité</strong> (carte d’identité ou passeport)</li>
            <li><strong>Justificatif de domicile</strong> récent</li>
            <li><strong>3 derniers bulletins de salaire</strong></li>
            <li><strong>Contrat de travail</strong> ou attestation d’emploi</li>
            <li><strong>Dernier avis d’imposition</strong></li>
            <li><strong>Relevés de compte</strong> des 3 derniers mois</li>
            <li><strong>Tableau d’amortissement</strong> si vous avez déjà un prêt en cours</li>
            <li><strong>Apport personnel</strong> justifié (livrets, épargne, donations…)</li>
          </ul>

    </br></br>
       <p>Un bon dossier rassure le vendeur et la banque, et permet de gagner du temps lors des négociations et démarches administratives.</p>
