...
<body class="index-page">
  ...
  <main class="main">
    <img src="assets/img/droits.jpg" alt="droits et devoirs du locataire"> 
        <h1>Louer un logement : droits et devoirs du locataire</h1></br>
    
        <p>En tant que locataire, vous bénéficiez de droits mais vous avez également des obligations envers le propriétaire et le logement que vous occupez.</p>
    
        <h2>Les droits du locataire</h2>
    <ul>
      <li>Jouir paisiblement du logement</li>
      <li>Bénéficier d’un logement décent</li>
      <li>Recevoir des quittances de loyer</li>
      <li>Être informé en cas de vente ou reprise du logement</li>
    </ul>

    <h2>Les devoirs du locataire</h2>
    <ul>
      <li>Payer le loyer et les charges à temps</li>
      <li>Entretenir le logement et effectuer les réparations locatives</li>
      <li>Utiliser le logement conformément à sa destination</li>
      <li>Respecter les règles de bon voisinage</li>
    </ul>

    <p>Connaître ses droits et devoirs permet de prévenir les conflits et de vivre sereinement dans son logement.</p>
