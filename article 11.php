...
<body class="index-page">
  ...
  <main class="main">
    <img src="assets/img/erreurs location.jpg" alt="Les 5 erreurs à éviter"> 
        <h1>Les 5 erreurs à éviter lors de la recherche d’un logement à louer</h1></br>
    
        <h2>1. Ne pas définir de budget précis</h2>
    <p>Il est essentiel de connaître votre capacité financière avant de chercher un logement pour éviter les visites inutiles.</p>

    <h2>2. Visiter sans poser les bonnes questions</h2>
    <p>Renseignez-vous sur les charges, l’état du logement, les travaux prévus, etc.</p>

    <h2>3. Ne pas lire attentivement le bail</h2>
    <p>Le contrat de location est un document juridique qu’il faut lire avec attention pour éviter les mauvaises surprises.</p>

    <h2>4. Fournir un dossier incomplet</h2>
    <p>Un dossier mal préparé diminue vos chances d’être retenu, surtout dans les zones tendues.</p>

    <h2>5. Se précipiter sans comparer</h2>
    <p>Comparer plusieurs logements et quartiers permet de faire un choix éclairé.</p>
  </main>
