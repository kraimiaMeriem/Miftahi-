...
<head>
  <meta charset="utf-8">
  <title>annonces de location Skikda</title>
 ...
 <main class="main">
            ...
            <div class="row d-flex align-items-stretch">
                <div class="col-md-12">
                    <div class="title-single-box">
                        <h1 class="title-single">Nos annonces à Skikda</h1>
                    </div>
                </div>
            </div>
        </div>
  ...
  <section class="property-grid grid">
            <div class="container">
                ...
                // Total des annonces
                $totalAnnonces = $db->query("SELECT COUNT(*) FROM bien_a_louer WHERE wilaya = '21'")->fetchColumn();
                $totalPages = ceil($totalAnnonces / $annoncesParPage);
