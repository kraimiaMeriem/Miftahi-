...
<head>
  <meta charset="utf-8">
  <title>annonces de location Tizi Ouzou</title>
 ...
 <main class="main">
            ...
            <div class="row d-flex align-items-stretch">
                <div class="col-md-12">
                    <div class="title-single-box">
                        <h1 class="title-single">Nos annonces à Tizi Ouzou</h1>
                    </div>
                </div>
            </div>
        </div>
  ...
  <section class="property-grid grid">
            <div class="container">
                ...
                // Total des annonces
                $totalAnnonces = $db->query("SELECT COUNT(*) FROM bien_a_louer WHERE wilaya = '15'")->fetchColumn();
                $totalPages = ceil($totalAnnonces / $annoncesParPage);
                                ...
                                <div class="card-overlay-a-content" style="position: relative;">
                                    <div class="card-header-a">
                                        <h2 class="card-title-a">
                                            ...
                                            <a href="annonce1.php?id=<?= $annonce['id']; ?>">
                                    ...
                                    <div class="card-body-a">
                                        ...
                                        <a href="annonce1.php?id=<?= $annonce['id']; ?>" class="link-a">Voir plus <span class="ion-ios-arrow-forward"></span></a>
                                    </div>
                                </div>
